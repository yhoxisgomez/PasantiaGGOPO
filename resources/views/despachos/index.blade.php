...
@section('content')
  ...
  <a href="{{url('despachos/create')}}"class="btn btn-app"><i class="fa fa-plus-circle"></i>Registrar
  </a>
  <div class="card">
  <div class="card-body table-responsive{-sm|-md|-lg|-xl}">
                       ...
                       @section('extra-scripts5')
                           ...
                           $('#buscarD').click(function (evt) {
                               ...
                               const route = '/despachos/'+FechaInicioD +'/'+ FechaFinD;
                               console.log('/despachos/'+FechaInicioD +'/'+ FechaFinD);
...
<br><center><h2>DESPACHOS</h2></center>
<table id="despachos" class="table table-responsive-sm table-striped table-bordered" style="text-align:center">
      		...
      		<tbody style="text-align:center">
      			...
      			<tr>
                    ...
                    <td>{{ number_format($c['toneladas']) }} </td>
      		        ...
      		        <a class="btn btn-app" href="{{url('/despachos/'.$c->id.'/edit')}}"><i class="fa fa-edit"></i>Editar
                    </a>

      				<form method="post" action="{{url('/despachos/'.$c->id)}}" style="display:inline">
      					{{csrf_field()}}
      					{{method_field('DELETE')}}
